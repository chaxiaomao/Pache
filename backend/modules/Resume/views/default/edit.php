...
use backend\modules\Resume\widgets\EntityDetail;

/* @var $this yii\web\View */
/* @var $model common\models\c2\entity\ResumeModel */

if($model->isNewRecord){
$this->title = Yii::t('app.c2', '{actionTips} {modelClass}: ', ['actionTips' => Yii::t('app.c2', 'Create'), 'modelClass' => Yii::t('app.c2', 'Resume Model'),]);
$this->params['breadcrumbs'][] = ['label' => Yii::t('app.c2', 'Resume Models'), 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
}
else{
$this->title = Yii::t('app.c2', '{actionTips} {modelClass}: ', ['actionTips' => Yii::t('app.c2', 'Update'), 'modelClass' => Yii::t('app.c2', 'Resume Model'),]) . ' ' . $model->id;
$this->params['breadcrumbs'][] = ['label' => Yii::t('app.c2', 'Resume Models'), 'url' => ['index']];
