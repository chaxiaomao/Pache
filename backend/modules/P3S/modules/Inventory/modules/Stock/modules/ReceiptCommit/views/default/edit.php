...
use backend\modules\P3S\modules\Inventory\modules\Stock\modules\ReceiptCommit\widgets\EntityDetail;

/* @var $this yii\web\View */
/* @var $model common\models\c2\entity\WarehouseReceiptCommitItemModel */

if($model->isNewRecord){
$this->title = Yii::t('app.c2', '{actionTips} {modelClass}: ', ['actionTips' => Yii::t('app.c2', 'Create'), 'modelClass' => Yii::t('app.c2', 'Warehouse Receipt Commit Item Model'),]);
$this->params['breadcrumbs'][] = ['label' => Yii::t('app.c2', 'Warehouse Receipt Commit Item Models'), 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
}
else{
$this->title = Yii::t('app.c2', '{actionTips} {modelClass}: ', ['actionTips' => Yii::t('app.c2', 'Update'), 'modelClass' => Yii::t('app.c2', 'Warehouse Receipt Commit Item Model'),]) . ' ' . $model->id;
$this->params['breadcrumbs'][] = ['label' => Yii::t('app.c2', 'Warehouse Receipt Commit Item Models'), 'url' => ['index']];
