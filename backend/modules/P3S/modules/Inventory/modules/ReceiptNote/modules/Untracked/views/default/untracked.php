...
$this->title = Yii::t('app.c2', 'Untracked');
            ...
            [
                ...
                'buttons' => [
                    ...
                    'check' => function ($url, $model, $key) {
                        ...
                        return Html::a(Html::tag('span', '', ['class' => "glyphicon glyphicon-pencil"]), ['check', 'id' => $model->id], [
                            'title' => $title,
                            'aria-label' => $title,
                            'data-pjax' => '0',
                            'class' => 'check'
                    ...
                    'commit' => function ($url, $model, $key) {
                        ...
                        return Html::a(Html::tag('span', Yii::t('app.c2', 'Commit'), ['class' => "glyphicon glyphicon-ok"]), ['commit', 'id' => $model->id], [
                            'title' => $title,
                            'aria-label' => $title,
                            'data-pjax' => '0',
                            'class' => 'commit'
