...
use backend\modules\P3S\modules\Inventory\modules\WarehouseSend\widgets\EntityDetail;

/* @var $this yii\web\View */
/* @var $model common\models\c2\entity\WarehouseSendItemModel */

if($model->isNewRecord){
$this->title = Yii::t('app.c2', '{actionTips} {modelClass}: ', ['actionTips' => Yii::t('app.c2', 'Create'), 'modelClass' => Yii::t('app.c2', 'Warehouse Send Item Model'),]);
$this->params['breadcrumbs'][] = ['label' => Yii::t('app.c2', 'Warehouse Send Item Models'), 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
}
else{
$this->title = Yii::t('app.c2', '{actionTips} {modelClass}: ', ['actionTips' => Yii::t('app.c2', 'Update'), 'modelClass' => Yii::t('app.c2', 'Warehouse Send Item Model'),]) . ' ' . $model->id;
$this->params['breadcrumbs'][] = ['label' => Yii::t('app.c2', 'Warehouse Send Item Models'), 'url' => ['index']];
