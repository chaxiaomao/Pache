...
use backend\modules\P3S\modules\Inventory\modules\Logs\widgets\EntityDetail;

/* @var $this yii\web\View */
/* @var $model common\models\c2\entity\InventoryNoteLog */

if($model->isNewRecord){
$this->title = Yii::t('app.c2', '{actionTips} {modelClass}: ', ['actionTips' => Yii::t('app.c2', 'Create'), 'modelClass' => Yii::t('app.c2', 'Inventory Note Log'),]);
$this->params['breadcrumbs'][] = ['label' => Yii::t('app.c2', 'Inventory Note Logs'), 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
}
else{
$this->title = Yii::t('app.c2', '{actionTips} {modelClass}: ', ['actionTips' => Yii::t('app.c2', 'Update'), 'modelClass' => Yii::t('app.c2', 'Inventory Note Log'),]) . ' ' . $model->id;
$this->params['breadcrumbs'][] = ['label' => Yii::t('app.c2', 'Inventory Note Logs'), 'url' => ['index']];
...
<?php Pjax::begin(['id' => 'inventory-note-log-pjax', 'enablePushState' => false]) ?>
