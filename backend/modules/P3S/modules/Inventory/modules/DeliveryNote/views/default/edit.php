...
if ($model->isNewRecord) {
    $this->title = Yii::t('app.c2', '{actionTips} {modelClass}: ', ['actionTips' => Yii::t('app.c2', 'Create'), 'modelClass' => Yii::t('app.c2', 'Inventory Delivery Notes'),]);
    $this->params['breadcrumbs'][] = ['label' => Yii::t('app.c2', 'Inventory Delivery Notes'), 'url' => ['index']];
    $this->params['breadcrumbs'][] = $this->title;
} else {
    $this->title = Yii::t('app.c2', '{actionTips} {modelClass}: ', ['actionTips' => Yii::t('app.c2', 'Update'), 'modelClass' => Yii::t('app.c2', 'Inventory Delivery Notes'),]) . ' #' . $model->code;
    $this->params['breadcrumbs'][] = ['label' => Yii::t('app.c2', 'Inventory Delivery Notes'), 'url' => ['index']];
...
<?php Pjax::begin(['id' => 'inventory-delivery-note-pjax', 'enablePushState' => false,'clientOptions' =>[
