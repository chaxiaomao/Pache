...
namespace backend\modules\P3S\modules\Config\modules\Warehouse\controllers;
...
/**
 * DefaultController implements the CRUD actions for WarehouseModel model.
 */
class DefaultController extends Controller
{
    ...
    /**
     * Displays a single WarehouseModel model.
     * @param string $id
     * @return mixed
     */
    ...
    /**
     * create/update a WarehouseModel model.
     * fit to pajax call
     * @return mixed
     */
    ...
    /**
     * Finds the WarehouseModel model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param string $id
     * @return WarehouseModel the loaded model
