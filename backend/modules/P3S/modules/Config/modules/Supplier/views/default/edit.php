...
use backend\modules\P3S\modules\Config\modules\Supplier\widgets\EntityDetail;

/* @var $this yii\web\View */
/* @var $model common\models\c2\entity\SupplierModel */

if($model->isNewRecord){
$this->title = Yii::t('app.c2', '{actionTips} {modelClass}: ', ['actionTips' => Yii::t('app.c2', 'Create'), 'modelClass' => Yii::t('app.c2', 'Supplier Model'),]);
$this->params['breadcrumbs'][] = ['label' => Yii::t('app.c2', 'Supplier Models'), 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
}
else{
$this->title = Yii::t('app.c2', '{actionTips} {modelClass}: ', ['actionTips' => Yii::t('app.c2', 'Update'), 'modelClass' => Yii::t('app.c2', 'Supplier Model'),]) . ' ' . $model->id;
$this->params['breadcrumbs'][] = ['label' => Yii::t('app.c2', 'Supplier Models'), 'url' => ['index']];
