...
use backend\modules\P3S\modules\Finance\modules\Order\modules\OrderItem\widgets\EntityDetail;

/* @var $this yii\web\View */
/* @var $model common\models\c2\entity\OrderItemModel */

if($model->isNewRecord){
$this->title = Yii::t('app.c2', '{actionTips} {modelClass}: ', ['actionTips' => Yii::t('app.c2', 'Create'), 'modelClass' => Yii::t('app.c2', 'Order Item Model'),]);
$this->params['breadcrumbs'][] = ['label' => Yii::t('app.c2', 'Order Item Models'), 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
}
else{
$this->title = Yii::t('app.c2', '{actionTips} {modelClass}: ', ['actionTips' => Yii::t('app.c2', 'Update'), 'modelClass' => Yii::t('app.c2', 'Order Item Model'),]) . ' ' . $model->id;
$this->params['breadcrumbs'][] = ['label' => Yii::t('app.c2', 'Order Item Models'), 'url' => ['index']];
