            ...
            'toolbar' => [
                [
                    'content' =>
                        ...
                        Html::a('<i class="glyphicon glyphicon-plus">' . Yii::t('app.c2', 'Material Add') . '</i>', ['edit-material'], [
                            'class' => 'btn btn-success material-edit',
                            'title' => Yii::t('app.c2', 'Add'),
                            'data-pjax' => '0',
                        ]) . ' ' .
                ...
                [
                    ...
                    'buttons' => [
                        ...
                        'material-update' => function ($url, $model, $key) {
                            return Html::a('<span class="glyphicon glyphicon-pencil"></span>', ['edit-material', 'id' => $model->id], [
                                'title' => Yii::t('app', 'Info'),
                                'data-pjax' => '0',
                                'class' => 'material-edit'
                            ]);
...
$js .= "jQuery(document).off('click', 'a.material-edit').on('click', 'a.material-edit', function(e) {
            e.preventDefault();
            jQuery('#material-edit').modal('show').find('.modal-content').html('" . Yii::t('app.c2', 'Loading...') . "').load(jQuery(e.currentTarget).attr('href'));
        });";
