...
/* @var $model common\models\c2\entity\ProductModel */

if ($model->isNewRecord) {
    $this->title = Yii::t('app.c2', '{actionTips} {modelClass}: ', ['actionTips' => Yii::t('app.c2', 'Create'), 'modelClass' => Yii::t('app.c2', 'Product Model'),]);
    $this->params['breadcrumbs'][] = ['label' => Yii::t('app.c2', 'Product Models'), 'url' => ['index']];
    $this->params['breadcrumbs'][] = $this->title;
} else {
    $this->title = Yii::t('app.c2', '{actionTips} {modelClass}: ', ['actionTips' => Yii::t('app.c2', 'Update'), 'modelClass' => Yii::t('app.c2', 'Product Model'),]) . ' ' . $model->id;
    $this->params['breadcrumbs'][] = ['label' => Yii::t('app.c2', 'Product Models'), 'url' => ['index']];
...
<?php echo EntityDetail::widget([
    ...
    'withSkuTab' => $model->type == \common\models\c2\statics\ProductType::TYPE_PRODUCT ? true : false,
]);
?>
