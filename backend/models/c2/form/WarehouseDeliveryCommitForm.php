...
class WarehouseDeliveryCommitForm extends Model
{
    use ModelTrait;
    ...
    {
        return 'InventoryDeliveryNoteModel';
    }
        ...
        if (!empty($this->items)) {
            foreach ($this->items as $item) {
                $attributes = [
                    ...
                    'actual_quantity' => isset($item['actual_quantity']) ? $item['actual_quantity'] : 0,
                    'stock_quantity' => isset($item['stock_quantity']) ? $item['stock_quantity'] : 0,
                ...
                if (isset($item['id']) && $item['id'] == 0) {  // create new items
                    ...
                    $itemModel = WarehouseDeliveryCommitItemModel::findOne(['id' => $item['id']]);
