...
/**
 * WarehouseCommitItemSearch represents the model behind the search form about `common\models\c2\entity\WarehouseCommitItemModel`.
 */
class WarehouseCommitItemSearch extends WarehouseCommitItemModel
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = WarehouseCommitItemModel::find();
    ...
    public function getPageParamName($splitor = '-'){
        $name = "WarehouseCommitItemModelPage";
        return \Yii::$app->czaHelper->naming->toSplit($name);
    }
    
    public function getSortParamName($splitor = '-'){
        $name = "WarehouseCommitItemModelSort";
        return \Yii::$app->czaHelper->naming->toSplit($name);
    }
}
