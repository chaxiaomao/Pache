...
class SupplierSearch extends SupplierModel
{
    ...
    public function rules()
    {
        return [
            ...
            [['code', 'name', 'label', 'geo_longitude', 'geo_latitude', 'geo_marker_color', 'description',
                'is_default', 'status', 'created_at', 'updated_at', 'contact_name', 'contact_phone', 'fax'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'code', $this->code])
            ...
            ->andFilterWhere(['like', 'label', $this->contact_name])
            ->andFilterWhere(['like', 'label', $this->contact_phone])
            ->andFilterWhere(['like', 'label', $this->fax])
